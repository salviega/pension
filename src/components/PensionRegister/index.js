...
function PensionRegister({ loading, setLoading }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await pensionContract.safeMint(
        biologySex,
        age,
        bornAge,
        firstQuote,
        ...
        <form onSubmit={handleSubmit}>
          <div className="row">
            <div className="col-half">
              ...
              <div className="input-group">
                <div className="col-third">
                  ...
                  <p
                    className={`error-msg ${
                      validate.birthDate && "error-msg--hidde"
                    }`}
                  >
            ...
            <div className="col-half">
              ...
              <p
                className={`error-msg ${validate.gender && "error-msg--hidde"}`}
          ...
          <div className="row">
            ...
            <div className="input-group input-group-icon">
              ...
              <p
                className={`error-msg ${
                  validate.firstDeposite && "error-msg--hidde"
                }`}
              >
                required field
              </p>
            ...
            <div className="input-group">
              ...
              <p
                className={`error-msg ${validate.check && "error-msg--hidde"}`}
              >
                required check
              </p>
            </div>
